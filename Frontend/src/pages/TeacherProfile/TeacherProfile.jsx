...
const Teacher = () => {
  ...
  const getData = async () => {
    try {
      ...
      setNumOfCourse(data.numofcourse);
    } catch (error) {
  ...
  return (
    <div className="">
      <div className=" m-12 grid gap-4 sm:grid-cols-12">
        <div className=" min-h-[100px] rounded  sm:col-span-8">
          <div className="left_container">
            ...
            <div className="instructor-profile--instructor-stats--cMiSc">
                <div className="instructor-profile--stat--zQM9I">
                  <div className="ud-heading-sm instructor-profile-stats-title--nB9RQ">Total Students</div>
                  <div className="ud-heading-xl" style={{fontWeight:'700', lineHeight: '1.2', fontSize: '1.9rem', color:'black'}}>1</div>
                </div>
        ...
        <div className="min-h-[100px] rounded  sm:col-span-4">
